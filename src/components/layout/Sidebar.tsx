...
export function Sidebar() {
  ...
  return (
    <motion.aside
      className={`fixed inset-y-0 z-40 flex flex-col bg-white dark:bg-gray-900 border-r-2 border-primary-100 dark:border-gray-800 shadow-xl transition-all duration-300 ${
    ...
    >
      ...
      <div className={`flex items-center px-6 py-6 border-b border-primary-100 dark:border-gray-800 ${
        ...
        {!sidebarOpen && (
          <motion.button
            onClick={toggleSidebar}
            className="absolute -right-4 top-6 p-2 rounded-xl bg-white dark:bg-gray-800 shadow-lg border border-primary-200 dark:border-gray-700 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-gray-700 transition-colors"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
